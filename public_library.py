...
libraries = []          # A unique set of libraries from the sample data
...
# Make a list of Library objects from the unique set of libraries
...
template = "{0:50}{1:15}"
print(libraries[1].library + "'s book list\n")
print(template.format("BOOK TITLE", "SHELF\n"))
for rec in sorted(libraries[1].list_books()):
